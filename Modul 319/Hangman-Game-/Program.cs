...
namespace HangmanGame
{
    ...
    {
        // Animation von Hangman (wenn er seine 6 versuche nicht richtig hatte)
        ...
        static void Main(string[] args)
        {
            ...
            List<string> wordDictionary = new List<string> { "haus", "diamant", "fussball", "fisch", "informatik", "hallo" };
